...
def load_players():
    ...
    checked_paths = [str(path) for path in DATA_PATHS]
    raise FileNotFoundError(
        "players.json was not found. Make sure backend-python/data/players.json is deployed. "
...
def health():
    ...
    return jsonify({"status": "ok", "dataFileFound": data_exists})
